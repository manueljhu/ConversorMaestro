 ...
 *
 */
public class RelacionCampExcel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RelacionCampExcel frame = new RelacionCampExcel();
	...
	public RelacionCampExcel() {
		...
		JLabel lblNewLabel = new JLabel("CREACIÓN DE CAMPOS DE ORIGEN EXCEL");
